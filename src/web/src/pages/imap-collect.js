  ...
  panelEl.innerHTML = `
    <div class="gw-log-header">
      <div class="gw-log-header-left">
        <i class="bi bi-terminal" style="color:#8a8a8a;"></i>
        ${user}
      </div>
...
function handleJobEvent(data) {
  ...
  panelEl.querySelector(".job-result-added").textContent =
    result.added_count ?? 0;
  panelEl.querySelector(".job-result-skipped").textContent =
