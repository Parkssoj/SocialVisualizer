...
"Top keywords" card — renders the top-10 keywords as a tag cloud sized by frequency. Each word
fades in with a staggered delay (same requestAnimationFrame + "show" class trick as the original).
 */
    ...
    <div className="rc-card">
      <div className="rc-card-header">
        <div className="rc-card-title">
          <div className="rc-card-title-icon" style={{ background: '#f0faf4' }}>✦</div>
          메일 속 주요 키워드
        </div>
      ...
      {status === 'loading' && (
        <div className="rc-loading"><div className="rc-spinner"></div>키워드 분석 중…</div>
      )}
